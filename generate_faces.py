...
# Hardware constraints: Match the ILI9341 LCD resolution
WIDTH = 320
HEIGHT = 240
...
draw.line((80, 80, 120, 80), fill=FG_COLOR, width=LINE_WIDTH)
draw.line((200, 80, 240, 80), fill=FG_COLOR, width=LINE_WIDTH)
draw.line((100, 160, 220, 160), fill=FG_COLOR, width=LINE_WIDTH)
save_face(img, "face_idle.png")

# 2. LISTENING (Attentive, wide eyes, slight smile)
img, draw = create_canvas()
draw.ellipse((80, 70, 120, 110), outline=FG_COLOR, width=LINE_WIDTH)
draw.ellipse((200, 70, 240, 110), outline=FG_COLOR, width=LINE_WIDTH)
draw.arc((100, 130, 220, 180), start=30, end=150, fill=FG_COLOR, width=LINE_WIDTH)
save_face(img, "face_listening.png")

# 3. THINKING (Squinting, processing)
img, draw = create_canvas()
draw.ellipse((80, 70, 120, 110), outline=FG_COLOR, width=LINE_WIDTH)
draw.line((200, 90, 240, 90), fill=FG_COLOR, width=LINE_WIDTH)
draw.ellipse((145, 160, 175, 180), outline=FG_COLOR, width=LINE_WIDTH)
save_face(img, "face_thinking.png")

# 4. SPEAKING (Active output)
img, draw = create_canvas()
draw.arc((80, 70, 120, 110), start=180, end=360, fill=FG_COLOR, width=LINE_WIDTH)
draw.arc((200, 70, 240, 110), start=180, end=360, fill=FG_COLOR, width=LINE_WIDTH)
draw.ellipse((110, 150, 210, 190), outline=FG_COLOR, width=LINE_WIDTH)
